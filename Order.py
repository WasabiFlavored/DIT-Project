...
class Restaurant:
    def __init__(self, root):
        ...
        root.grid_rowconfigure(0, weight=0)  # Row for menu bar
        root.grid_rowconfigure(1, weight=1)  # Row for main content
        root.grid_columnconfigure(0, weight=1)  # Main content column
